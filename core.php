...
<div class="main-content">
    <center>
        <h1>Core</h1>
        <p>Welcome to the Core Dashboard!</p>
    </center>
    ...
    <div class="dashboard-folders">
        ...
        <div class="folder-item">
            <a href="core/core2.php">
                <i class="folder-icon fas fa-folder-open"></i> <!-- Open folder icon -->
                <p>APPROVAL</p>
            </a>
        </div>
        <div class="folder-item">
        ...
        <div class="folder-item">
            <a href="core/core5.php">
                <i class="folder-icon fas fa-chart-pie"></i> <!-- Sales Monitoring icon -->
                <p>SALES MONITORING</p>
            </a>
        </div>
        <div class="folder-item">
            <a href="core/core6.php">
                <i class="folder-icon fas fa-user-friends"></i> <!-- Customer Accounts Monitoring icon -->
                <p>CUSTOMER ACC. MONITORING</p>
            </a>
        </div>
    </div>
</div>
